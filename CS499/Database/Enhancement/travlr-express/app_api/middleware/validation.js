...
// Minimal sanitizer to strip keys that could enable NoSQL injection
...
const handleValidationErrors = (req, res, next) => {
    // Basic sanitization to guard against NoSQL injection via query/body/params keys
...
const tripValidation = {
    create: [
        ...
        body('length')
            ...
            .isInt({ min: 1 }).withMessage('Trip length must be at least 1 day'),
        body('start')
        ...
        body('perPerson')
            ...
            .isFloat({ min: 0 }).withMessage('Price must be a valid non-negative number'),
        body('image')
            .trim()
